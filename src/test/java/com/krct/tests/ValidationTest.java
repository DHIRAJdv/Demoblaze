...
public class ValidationTest extends BaseTest {
    ...
    public void modalFieldRetainTest() {
        ...
        String actualUser = driver.findElement(org.openqa.selenium.By.id("loginusername")).getAttribute("value");
        String actualPass = driver.findElement(org.openqa.selenium.By.id("loginpassword")).getAttribute("value");
